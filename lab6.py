...
print(f"Соотношение зарплаты к рабочим часам для сотрудника: {officer.salary_to_hours_ratios()}")
print(f"Соотношение зарплаты к рабочим часам для старшего сотрудника: {senior_officer.salary_to_hours_ratios()}")
print(f"Соотношение зарплаты к рабочим часам для директора: {director.salary_to_hours_ratios()}")
